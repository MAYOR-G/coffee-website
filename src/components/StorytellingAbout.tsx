    ...
    <section id="about" className="py-24 bg-coffee-light overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          >
            <h2 className="font-serif text-4xl md:text-5xl text-coffee-dark mb-4">{siteContent.about.headline}</h2>
            <h3 className="font-sans text-coffee-terracotta tracking-widest uppercase text-sm mb-8">{siteContent.about.subheadline}</h3>
            
            <div className="space-y-6 text-coffee-dark/80 font-light leading-relaxed">
              <p className="text-lg">{siteContent.about.text1}</p>
              <p className="text-lg">{siteContent.about.text2}</p>
            </div>
