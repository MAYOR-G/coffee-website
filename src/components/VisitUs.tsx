            ...
            <div className="space-y-8 font-sans font-light">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-coffee-light/80">{siteContent.visit.address}</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-coffee-light/80">{siteContent.visit.phone}</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-coffee-light/80">{siteContent.visit.email}</p>
                </div>
              </div>
            </div>
          </motion.div>
